                ...
                <div className="product-item-content">
                    ...
                    <div>
                        ...
                        <div className="car-buttons mt-5">
                            <Button label='Ver todos los productos' icon="pi pi-eye" className="bg-orange-100 p-button-rounded" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="card">
                    <div className="flex card-container overflow-hidden">
                        <div className="flex flex-column align-items-center justify-content-center m-2 px-5 border-round">
                            <img src="src/images/LogoAguila.jpg" alt="Logo Multicomercio" className='border-round-xl w-20rem h-6rem cursor-pointer' onClick={logo} title='Multicomercio'  />
                        </div>
