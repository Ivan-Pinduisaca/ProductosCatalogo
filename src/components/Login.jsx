        ...
        <div className="flex align-items-center justify-content-center card-container h-screen">
          <div className="surface-card p-4 shadow-2 border-round lg:w-4">
            <div className="text-center mb-5">
              ...
              <a className="font-medium no-underline ml-2 text-900 cursor-pointer">
                Crear cuenta!
              </a>
            </div>
            ...
            <div>
              ...
              <div className="flex align-items-center justify-content-between mb-6">
                ...
                <a className="font-medium no-underline ml-2 text-right cursor-pointer text-900">
              ...
              <div className="flex align-items-center justify-content-center">
                <Button
                  ...
                  icon="pi pi-user"
                  className="w-30rem p-button-rounded p-button-success p-3"
                />
              </div>
            </div>
          </div>
